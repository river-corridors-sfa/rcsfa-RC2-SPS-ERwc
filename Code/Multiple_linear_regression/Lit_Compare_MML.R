...
# Keeps Devol Min/Max 
erwc_lit = read_xlsx(file.path("C:/Users/laan208/OneDrive - PNNL/Water_Column_Respiration_Spatial/Drafts/Maggi/Supplementary Information/Table_S5_Calculations.xlsx"), skip = 1,sheet = 2) %>% 
